        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-300 shadow-sm rounded-lg p-8 prose prose-headings:font-serif dark:prose-invert max-w-none">
                ...
                <ul>
                    ...
                    <li>Use Site content, images, descriptions, or data — in whole or in part — as training data, fine-tuning data, evaluation data, or any other input for artificial intelligence or machine learning models, systems, or products, for any purpose, by any individual, organization, or entity other than Gem Reptiles</li>
                </ul>
                ...
                <p>The Site is provided "as is" without warranties of any kind, express or implied. Gem Reptiles does not warrant that the Site will be uninterrupted, error-free, or free of harmful components.</p>

                <h2>Limitation of Liability</h2>
                <p>To the fullest extent permitted by law, Gem Reptiles shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of, or inability to use, the Site or any content or services provided through it.</p>
