...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', env('MAIL_FROM_ADDRESS', 'jeremy@gemreptiles.com')),

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'jeremy@gemreptiles.com'),
                'name'    => env('MAIL_FROM_NAME', 'Jeremy Gem Reptiles'),
            ],
        ],
