...
- For each changeset: Checkout git branch "main", git pull main, then create a new branch with a name formatted like "feature/description-of-feature" and checkout the feature branch. 
